    ...
    <div class="container">
        ...
        <form action="appointment.jsp" method="post">
            ...
            <select id="specialist" name="specialist" required>
                ...
                %>
                <option value="<%= doctorName %>" style="font-family+9:'Arial',sans-serif; font-weight:bold"> Dr. <%= doctorName %> - &nbsp;<%= specialization %> Specialist</option>
                <% 
                    }
                } catch (Exception e) {
        ...
        // Proceed with booking the new appointment (no need to check for duplicate email in the appointment table)
        try {
