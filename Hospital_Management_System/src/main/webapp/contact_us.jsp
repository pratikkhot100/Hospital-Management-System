...
#contact form {
	font-size: 0.9rem; /* Smaller form text */
}

#contact .form-control {
	padding: 0.6rem; /* Smaller input fields */
}

#contact button {
	padding: 0.4rem 1.4rem; /* Smaller button */
}
	...
	<div id="contact" class="container my-3">
		...
		<div class="row">
			...
			<div class="col-md-6">
				...
				<p>If you have any inquiries, feedback, or need assistance, feel
					free to reach out to us. Our team is dedicated to providing the
					best care and services for you.</p>
				<form action="contact_us.jsp" method="post">
					...
					<div class="mb-2">
						...
						<textarea class="form-control" id="message" name="message"
							rows="4" placeholder="Please enter your message here" required
