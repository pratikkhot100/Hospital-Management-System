...
<%@ include file="../component/ViewDoctorCSS.jsp"%>
</head>
<body>
	...
	<div class="container">
		...
		<div class="search-box">
			<form action="viewDoctor.jsp" method="get">
				<input type="text" name="searchQuery"
					placeholder="Search by name or specialization" required>
		...
		try {
			...
			if (searchQuery != null && !searchQuery.isEmpty()) {
				q = "SELECT * FROM doctor WHERE Full_name LIKE ? OR Specialization LIKE ? OR Registration_date LIKE ?";
			} else {
			...
			while (rs.next()) {
				...
				out.println("<td>" + rs.getString("Registration_date") + "</td>");
				out.println("</tr>");
			}
