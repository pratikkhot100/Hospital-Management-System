        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    <li class="nav-item" style="margin-right:10px;"><a class="btn btn-secondary" href="viewReviewDoctor.jsp">View Feedback</a></li>
                    <li class="nav-item" style="margin-right:10px;"><a class="btn btn-warning" href="ViewDoctorslist.jsp">View Doctors</a></li>
                    <li class="nav-item"><a class="btn btn-primary" href="index.jsp">Logout</a></li>
                </ul>
            </div>
        </div>
    </nav>
